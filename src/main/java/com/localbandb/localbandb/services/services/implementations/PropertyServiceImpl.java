...
public class PropertyServiceImpl implements PropertyService {
    ...
    public List<PropertyViewModel> getMyProperties() {
        List<Property> myProperties = propertyRepository.findAllByHost_Username(authenticationFacade.getAuthentication().getName());
    ...
    @Override
    @Secured("ROLE_HOST")
    public boolean addPictureToProperty(String id, PictureAddModel pictureAddModel) {
        try {
            ...
            property.getPictures().add(pictureAddModel.getPictureUrl());
    ...
    public PropertyViewModel getPropertyViewModel(Property p) {
        ...
        propertyViewModel.setReviewViewModels(reviewViewModels);
