...
public class ReservationController extends BaseController {
    public static final String PAGE_TITLE = "My reservations";
    ...
    public ModelAndView createConfirm(@ModelAttribute ReservationCreateModel model, ModelAndView modelAndView, RedirectAttributes attributes) {
        ...
        List<PropertyViewModel> properties = propertyService
                .getAllPropertyServiceModelsByCityAndFilterBusyDatesAndOccupancy(model.getCity(),
                        model.getStartDate(), model.getEndDate(), model.getOccupancy());
